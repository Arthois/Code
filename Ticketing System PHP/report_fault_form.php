...
<nav>
    ...
    <div class="report-form-form">                                              <!-- Fault reporting form -->
        <form action="report_fault.php" method="POST">                          <!-- Information snet forward with $_POST -->
            ...
            <textarea type="text" style="margin-top: 10px;" name="description" placeholder="Fault Description.. 40 char" maxlength="40" required></textarea>
            <br>
...
{
    header("Location: report_fault_form_admin.php");            // If not redirects
}

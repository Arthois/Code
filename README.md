...
# Some PHP Code allowing the user to accces a database of their choice and interact with it using SQL statements allowing to update, delete, edit user order or other data.
...
# Manually written code is in:
# Customer.cs // Form1.cs // Form2.cs // Form3.cs // Form4.cs
...
# BASH - BASH scripting
# A console based application for Linux based systems automating simple administrative tasks.
